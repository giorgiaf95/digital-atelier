  ...
  <footer className="border-t border-border bg-card/50 mt-20 pb-16 xl:pb-0">
    <div className="container mx-auto px-4 py-12">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          <span className="font-display text-xl font-bold gradient-text">DIGITAL ATELIER</span>
        ...
        <div>
          <h4 className="font-display font-semibold text-foreground mb-3">Altro</h4>
          <div className="flex flex-col gap-2 text-sm text-muted-foreground">
        ...
        <div>
          ...
          <p className="text-muted-foreground text-sm">info@digitalatelier.com</p>
      ...
      <div className="border-t border-border mt-8 pt-6 text-center text-muted-foreground text-xs">
        © 2026 Digital Atelier. Tutti i diritti riservati.
      </div>
    </div>
  </footer>
);
